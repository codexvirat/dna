...
export default function RegisterPage() {
  ...
  const handleGoogleSignUp = () => {
    alert("Google OAuth is mocked for now! You can register with random data using the form.");
  };
  ...
  return (
    <div className="container section-padding flex-center" style={{ minHeight: '80vh' }}>
      <div className="glass-panel" style={{ width: '100%', maxWidth: '450px', padding: '3rem' }}>
        <h1 className="text-gradient text-center" style={{ marginBottom: '0.5rem' }}>Create Account</h1>
        <p className="text-center" style={{ marginBottom: '2rem', color: 'var(--text-secondary)' }}>
          Join the elite aesthetics club.
        </p>
        ...
        <button onClick={handleGoogleSignUp} className="btn-secondary" style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem' }}>
